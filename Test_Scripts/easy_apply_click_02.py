...
This versionn of the Easy Apply button click test uses a nested fuction
instead of the original four try-except blocks. The script loops over each method 
...
class LinkedInClick:
    ...
    def click_ez_button(self):
        """
        This method uses multiple nested functions to find and click the Easy Apply button on LinkedIn job listings.
        """
        ...
        click_button(self.driver, '//div[contains(@id, "ember")]/svg')
        click_button(self.driver, '/html/body/div[4]/div[3]/div[4]/div/div/main/div/div[2]/div[2]/div/div[2]/div/div[1]/div/div[1]/div/div[1]/div/div[6]/div/div/div/button/svg')
        click_button(self.driver, By.CSS_SELECTOR,
        ...
        try:
            ...
            if button:
                ...
                print("Beautiful Soup: Easy Apply Button Not Found!")
        except Exception as e:
            print("An error occurred while clicking the Easy Apply button: ", str(e))
        finally:
            # If the button is not found, remain logged in until the user manually closes the browser.
